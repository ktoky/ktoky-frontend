...
export default function Card() {
  return (
    <div className="group border border-[#ececec] hover:border-[#BCE3C9] rounded-2xl hover:shadow-custom group-hover:transition group-hover:duration-300 p-[25px] relative">
      <div className="">
      ...
      <div className="hidden group-hover:block">
        <div className="flex gap-1 text-[#3BB77E] bg-white rounded-md absolute top-28 left-[85px]">
